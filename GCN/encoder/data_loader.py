...
class InputFeatures(object):
  ...
  def __init__(self, label_id=None, input_pos=None):
...
def StringInput2FeatureInput(examples, label_list, full_label_name_array):
...
def MakeDataLoader4Model (train_features,batch_size,fp16=False,sampler='random',metric_option='cosine') :
  ...
  train_data = TensorDataset ( all_input_1_pos, all_input_2_pos, all_label_ids )
