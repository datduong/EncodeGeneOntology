...
in_dir = "/u/scratch/a/auppunda/deepgo2/data/train"
os.chdir(out_dir)
...
for ontology in ontology_type: 
  ...
  go_name_array = pd.read_pickle(in_dir+"/"+ontology+"2.pkl") ## terms used in prediction
  ...
  for data_type in data_types: 
    ...
    ## can't trust the 1-hot, it can be linked to the old model 
