...
mkdir $work_dir/'RandomGOAnalysis/GCNOnto2vec'

model_load=$work_dir/'GCNOnto2vec/'$metric_option'.300/best_state_dict.pytorch'

result_folder=$work_dir/'RandomGOAnalysis/GCNOnto2vec/'$metric_option'.300' #$def_emb_dim.'clsVec'
mkdir $result_folder
