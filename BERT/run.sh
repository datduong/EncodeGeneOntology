...
bert_model='/local/datdb/goAndGeneAnnotationDec2018/BERT_base_cased_tune_go_branch/finetuned_lm_bioBERT/'
CUDA_VISIBLE_DEVICES=3 /local/datdb/anaconda3/envs/tensorflow_gpuenv/bin/python -u run_classifier.py --data_dir $data_dir --output_dir $output_dir --bert_model $bert_model --bert_model_tokenizer bert-base-cased --task_name qnli --fp16 --num_train_epochs 5 --do_train --max_seq_length 384 --train_batch_size 24
