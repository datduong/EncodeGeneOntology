...
output_dir='/local/datdb/goAndGeneAnnotationMar2017/entailment_data/AicScore/go_bert_cls/model_cased_bioBERT/'
...
python3 pregenerate_training_data.py --train_corpus /local/datdb/goAndGeneAnnotationMar2017/BERT_go_branch.txt --bert_model bert-base-cased --output_dir /local/datdb/goAndGeneAnnotationMar2017/BERT_base_cased_tune_go_branch/ --epochs_to_generate 5 --max_seq_len 384

## tune MaskLM and NextSentence task
conda activate tensorflow_gpuenv
bert_model='/local/datdb/BERTPretrainedModel/pubmed_pmc_470k/'
cd /local/datdb/pytorch-pretrained-BERT/examples/lm_finetuning
CUDA_VISIBLE_DEVICES=1 /local/datdb/anaconda3/envs/tensorflow_gpuenv/bin/python -u finetune_on_pregenerated.py --pregenerated_data /local/datdb/goAndGeneAnnotationMar2017/BERT_base_cased_tune_go_branch/ --bert_model_tokenizer bert-base-cased --bert_model $bert_model --output_dir /local/datdb/goAndGeneAnnotationMar2017/BERT_base_cased_tune_go_branch/finetuned_lm_bioBERT/ --epochs 5 --train_batch_size 24 --fp16
...
cd /local/datdb/pytorch-pretrained-BERT/examples/
data_dir='/local/datdb/goAndGeneAnnotationMar2017/entailment_data/AicScore/go_bert_cls/'
output_dir='/local/datdb/goAndGeneAnnotationMar2017/BERT_base_cased_tune_go_branch/finetuned_lm_bioBERT/model_cased_bioBERT/'
bert_model=$output_dir
