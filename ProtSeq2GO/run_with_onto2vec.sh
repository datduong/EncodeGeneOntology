...
precomputed_vector='/local/datdb/Onto2Vec/GOVectorData/2016DeepGOData/onto2vec_embeddings_2016.pickle'

for fold in 1 ; do 

for ontology in mf cc ; do # cc bp bp
...
result_folder=$data_dir/'FlatSeqProtHwayOnto2vec.'$ontology
