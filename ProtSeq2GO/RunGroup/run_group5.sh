...
precomputed_vector='/local/datdb/deepgo/data/BertAsServiceVector/label_vector.pickle'  ####
  ...
  for lr in 0.0005 ; do
    for fold in 1 ; do
      for ontology in mf cc bp ; do # cc bp bp mf cc
        ...
        ##!!##!!##!!##!!
        result_folder=$data_dir/$model_choice'BertAsService' #$add_name
        mkdir $result_folder
        result_folder=$data_dir/$model_choice'BertAsService/NotNormalize' #$add_name
        mkdir $result_folder
...
precomputed_vector='/local/datdb/deepgo/data/BertFineTuneGOEmb768ResultEpoch100/GOname_vector.pickle' ####
weight_decay=0
batch_size_aa_go=32
optim_choice='RMSprop'
sgd_lr=0.0001
  ...
  for lr in 0.0005 ; do
    for fold in 1 ; do
      for ontology in mf cc bp ; do # cc bp bp mf cc
        ...
        ##!!##!!##!!##!!
        result_folder=$data_dir/$model_choice'BertGOName' #$add_name
        mkdir $result_folder
        result_folder=$data_dir/$model_choice'BertGOName/NotNormalize' #$add_name
        mkdir $result_folder
