  ...
  for lr in 0.001 ; do
    for fold in 1 ; do
      for ontology in cc ; do # cc bp bp mf cc
        ...
        mkdir $result_folder
        result_folder=$data_dir/$model_choice'BertAve12/NotNormalize' #$add_name
        mkdir $result_folder
  ...
  for lr in 0.0001 ; do
    for fold in 1 ; do
      for ontology in mf cc bp ; do # cc bp bp mf cc
        ...
        mkdir $result_folder
        result_folder=$data_dir/$model_choice'Bertd11d12/NotNormalize' #$add_name 
        mkdir $result_folder
