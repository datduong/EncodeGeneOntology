...
for fold in 1 ; do 
  for ontology in cc ; do # cc bp bp mf cc
    ...
    result_folder=$data_dir/'BertFineTuneGOEmb768ResultEpoch100B32.'$def_emb_dim.$ontology
    # prot2seq_model_load=$result_folder/'best_state_dict.pytorch'

    ## continue training redefine result, and save to new location
    # result_folder=$data_dir/'FlatSeqProtHwayBertAveWordClsSepL12PretrainR2.'$def_emb_dim.$ontology
    mkdir $result_folder
