...
for lr in 0.0005 ; do
  for fold in 1 ; do
    for ontology in mf cc bp ; do # cc bp bp mf cc
      ...
      result_folder=$data_dir/$model_choice'BaseExtraLayer'
      mkdir $result_folder
