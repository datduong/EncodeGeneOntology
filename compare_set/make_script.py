...
result_folder=$work_dir/'cosine768Linear768Layer11+12nnParamOpW2/'
mkdir $result_folder
...
vector_file=$work_dir/'cosine768Linear768Layer11+12nnParamOpW2/label_vector.pickle'
...
finalDir=$outDir/'cosine768Linear768Layer11+12nnParamOpW2'
mkdir $finalDir
...
for point in {0..ENDPOINT..GAP} ;  do
  ...
  saveDf=$outDir/'PPI2testDef.'$point'.txt' # Ortholog2testDef
  # saveDf=$outDir/'Ortholog2testDef.'$point'.txt' # Ortholog2testDef
